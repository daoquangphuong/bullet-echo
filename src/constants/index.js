const KEY_EVENT = {
  ...
  FLAG_CANCELED_LONG_PRESS: 'FLAG_CANCELED_LONG_PRESS',
  FLAG_EDITOR_ACTION: 'FLAG_EDITOR_ACTION',
  FLAG_FALLBACK: 'FLAG_FALLBACK',
  FLAG_FROM_SYSTEM: 'FLAG_FROM_SYSTEM',
  FLAG_KEEP_TOUCH_MODE: 'FLAG_KEEP_TOUCH_MODE',
  FLAG_LONG_PRESS: 'FLAG_LONG_PRESS',
  FLAG_SOFT_KEYBOARD: 'FLAG_SOFT_KEYBOARD',
  FLAG_TRACKING: 'FLAG_TRACKING',
  FLAG_VIRTUAL_HARD_KEY: 'FLAG_VIRTUAL_HARD_KEY',
  FLAG_WOKE_HERE: 'FLAG_WOKE_HERE',
  KEYCODE_0: 'KEYCODE_0',
  KEYCODE_1: 'KEYCODE_1',
  ...
  KEYCODE_DEMO_APP_1: 'KEYCODE_DEMO_APP_1',
  KEYCODE_DEMO_APP_2: 'KEYCODE_DEMO_APP_2',
  KEYCODE_DEMO_APP_3: 'KEYCODE_DEMO_APP_3',
  KEYCODE_DEMO_APP_4: 'KEYCODE_DEMO_APP_4',
  ...
  KEYCODE_FEATURED_APP_1: 'KEYCODE_FEATURED_APP_1',
  KEYCODE_FEATURED_APP_2: 'KEYCODE_FEATURED_APP_2',
  KEYCODE_FEATURED_APP_3: 'KEYCODE_FEATURED_APP_3',
  KEYCODE_FEATURED_APP_4: 'KEYCODE_FEATURED_APP_4',
  ...
  KEYCODE_PROFILE_SWITCH: 'KEYCODE_PROFILE_SWITCH',
  ...
  KEYCODE_THUMBS_DOWN: 'KEYCODE_THUMBS_DOWN',
  KEYCODE_THUMBS_UP: 'KEYCODE_THUMBS_UP',
  ...
  KEYCODE_V: 'KEYCODE_V',
  KEYCODE_VIDEO_APP_1: 'KEYCODE_VIDEO_APP_1',
  KEYCODE_VIDEO_APP_2: 'KEYCODE_VIDEO_APP_2',
  KEYCODE_VIDEO_APP_3: 'KEYCODE_VIDEO_APP_3',
  KEYCODE_VIDEO_APP_4: 'KEYCODE_VIDEO_APP_4',
  KEYCODE_VIDEO_APP_5: 'KEYCODE_VIDEO_APP_5',
  KEYCODE_VIDEO_APP_6: 'KEYCODE_VIDEO_APP_6',
  KEYCODE_VIDEO_APP_7: 'KEYCODE_VIDEO_APP_7',
  KEYCODE_VIDEO_APP_8: 'KEYCODE_VIDEO_APP_8',
  ...
  META_ALT_LEFT_ON: 'META_ALT_LEFT_ON',
  META_ALT_MASK: 'META_ALT_MASK',
  META_ALT_ON: 'META_ALT_ON',
  META_ALT_RIGHT_ON: 'META_ALT_RIGHT_ON',
  META_CAPS_LOCK_ON: 'META_CAPS_LOCK_ON',
  META_CTRL_LEFT_ON: 'META_CTRL_LEFT_ON',
  META_CTRL_MASK: 'META_CTRL_MASK',
  META_CTRL_ON: 'META_CTRL_ON',
  META_CTRL_RIGHT_ON: 'META_CTRL_RIGHT_ON',
  META_FUNCTION_ON: 'META_FUNCTION_ON',
  META_META_LEFT_ON: 'META_META_LEFT_ON',
  META_META_MASK: 'META_META_MASK',
  META_META_ON: 'META_META_ON',
  META_META_RIGHT_ON: 'META_META_RIGHT_ON',
  META_NUM_LOCK_ON: 'META_NUM_LOCK_ON',
  META_SCROLL_LOCK_ON: 'META_SCROLL_LOCK_ON',
  META_SHIFT_LEFT_ON: 'META_SHIFT_LEFT_ON',
  META_SHIFT_MASK: 'META_SHIFT_MASK',
  META_SHIFT_ON: 'META_SHIFT_ON',
  META_SHIFT_RIGHT_ON: 'META_SHIFT_RIGHT_ON',
  META_SYM_ON: 'META_SYM_ON',
};
